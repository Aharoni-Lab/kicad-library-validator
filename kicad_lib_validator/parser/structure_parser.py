...
def _validate_directory_structure(structure: LibraryStructure, library_root: Path) -> None:
    ...
    if hasattr(structure.library.directories, 'models_3d') and structure.library.directories.models_3d:
    ...
    if hasattr(structure.library.directories, 'documentation') and structure.library.directories.documentation:
